...
public class HandleKeyboardMouse 
{
	...
	public void handleframes() throws Exception
	{
		...
		CaptureScreen.testResults(driver,"handleframes");
	}
	...
	public void handleAlerts() throws Exception
	{
		...
		CaptureScreen.testResults(driver,"handleAlerts");
	}
	...
	public void handlekeybords()
	{
		...
		act.keyDown(Keys.CONTROL).sendKeys("a").keyDown(Keys.CONTROL).sendKeys(Keys.BACK_SPACE).perform();
